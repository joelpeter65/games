...
class MathGameSabtractionScreen extends StatefulWidget {
  const MathGameSabtractionScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MathGameSabtractionScreenState createState() =>
      _MathGameSabtractionScreenState();
}

class _MathGameSabtractionScreenState extends State<MathGameSabtractionScreen> {
          ...
          actions: [
            Center(
              child: TextButton(
                ...
                child: Text('Play Flappy Bird Game'),
              ),
            ),
            Center(
              child: TextButton(
